A simple web-based "Guess the Number" game using HTML, CSS, and JavaScript. The user tries to guess a randomly generated number between 1 and 100 with score tracking and feedback.
